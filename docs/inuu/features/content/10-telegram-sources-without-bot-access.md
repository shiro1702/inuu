...
### Альтернатива для публичных каналов: `t.me/s/`

Без MTProto можно парсить HTML `https://t.me/s/{channel}` (cheerio, стабильные селекторы). Ограничение: rate limit (~1–2 ч на канал), нет закрытых каналов.

Подробно: **[27-ingest-workers-vk-telegram-web.md](./27-ingest-workers-vk-telegram-web.md)** (брейншторм [01.06.2026](../../../fix/brainstorm/01.06.2026.md)).
