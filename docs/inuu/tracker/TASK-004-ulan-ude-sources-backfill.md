...
- [ ] ≥12 TG + ≥4 web в `city_*_sources` для `ulan-ude`
- [ ] ≥15 опубликованных событий на витрине (seed + approve из очереди)
- [ ] 2 web URL с `cron_enabled` отрабатывают без fatal alert
- [ ] Backfill хотя бы 2 активных TG без flood ошибок
