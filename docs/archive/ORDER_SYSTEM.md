# Система заказов (legacy PocketMenu)

> **Архив.** Продукт INUU использует **bookings**, не food-orders. Канон: [../inuu/09-data-model-overview.md](../inuu/09-data-model-overview.md), [../inuu/implementation/02-refactor-existing.md](../inuu/implementation/02-refactor-existing.md).

Документ описывает, как устроена и работала система заказов еды в проекте: каналы (Web и Telegram Mini App), эндпоинты, авторизация, жизненный цикл заказа и уведомления.
