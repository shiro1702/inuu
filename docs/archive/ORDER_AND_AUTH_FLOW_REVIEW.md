# Обзор флоу заказа и авторизации (legacy)

> **Архив.** Food-order + `checkout.vue`. INUU: [../features/TELEGRAM_AUTH_VIA_BOT_RU.md](../features/TELEGRAM_AUTH_VIA_BOT_RU.md), bookings API.
