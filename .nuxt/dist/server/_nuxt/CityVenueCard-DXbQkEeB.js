        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (__props.venue.editorial_quote) {
              _push2(`<p class="mt-2 text-sm italic text-gray-600"${_scopeId}> «${ssrInterpolate(__props.venue.editorial_quote)}» </p>`);
            } else {
              _push2(`<!---->`);
            }
            if (__props.venue.vibe_tags?.length) {
            ...
            return [
              ...
              createVNode("div", { class: "p-4" }, [
                ...
                }, " «" + toDisplayString(__props.venue.editorial_quote) + "» ", 1)) : createCommentVNode("", true),
                __props.venue.vibe_tags?.length ? (openBlock(), createBlock("div", {
                  key: 2,
