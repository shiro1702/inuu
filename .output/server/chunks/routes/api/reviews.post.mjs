import { y as defineEventHandler, aA as readBody, t as createError, aE as requireTenantShop, aD as requireReviewsFeature, aL as resolveReviewIdentity, aC as requireOwnedOrderForReview, a6 as insertShopReview } from '../../nitro/nitro.mjs';
import 'node:crypto';
import '@supabase/ssr';
import 'node:http';
import 'node:https';
