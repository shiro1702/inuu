import { y as defineEventHandler, Y as getRouterParam, t as createError, T as getQuery, aK as resolveFestivalOrThrow, aS as serverSupabaseServiceRole } from '../../../../nitro/nitro.mjs';
import 'node:crypto';
import '@supabase/ssr';
import 'node:http';
import 'node:https';
