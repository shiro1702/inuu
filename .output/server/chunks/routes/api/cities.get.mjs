import { y as defineEventHandler, aW as setResponseHeader, T as getQuery, a$ as useRuntimeConfig, t as createError, aS as serverSupabaseServiceRole } from '../../nitro/nitro.mjs';
import 'node:crypto';
import '@supabase/ssr';
import 'node:http';
import 'node:https';
